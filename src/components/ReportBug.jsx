  ...
  return (
    <>
      ...
      <motion.button
        ...
        className="fixed bottom-6 right-6 z-40 flex items-center gap-2 bg-gray-900 dark:bg-gray-800 text-white text-xs font-bold px-4 py-2.5 rounded-full shadow-xl hover:bg-gray-700 dark:hover:bg-gray-700 transition-colors"
      >
